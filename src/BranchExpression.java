...
public class BranchExpression extends LiteralExpression implements CompoundExpression {
    ...
    @Override
    public void flatten() {// class expr factor out
    ...
    Expression getMostSpecificFocus (double x, double y){
        for (Expression expr: _children) {
            if (true /* && expr.contains(x, y)*/){
                //return expr.getMostSpecificFocus(x, y);
            }
        }
        return null;
    }
